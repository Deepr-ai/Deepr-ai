 ...
 */
      ...
      __pyx_t_3 = PyFloat_FromDouble((((double)__pyx_v_position) / __pyx_t_14)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = NULL;
 ...
 */
        ...
        __pyx_t_5 = PyFloat_FromDouble((((double)__pyx_v_position) / __pyx_t_14)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 23, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_4 = NULL;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
          __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
