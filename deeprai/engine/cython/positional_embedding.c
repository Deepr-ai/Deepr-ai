 ...
 */
      ...
      __pyx_t_3 = __Pyx_PyInt_From_long(__Pyx_div_long(__pyx_v_position, __pyx_t_14)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 22, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = NULL;
      ...
      __pyx_t_18 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_pybuffernd_position_embedding.diminfo[0].shape;
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_pybuffernd_position_embedding.diminfo[0].shape)) __pyx_t_18 = 0;
      if (__pyx_t_17 < 0) {
 ...
 */
        ...
        __pyx_t_5 = __Pyx_PyInt_From_long(__Pyx_div_long(__pyx_v_position, __pyx_t_13)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 24, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_4 = NULL;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
          __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
        ...
        } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_position_embedding.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_16 < 0) {
          __pyx_t_16 += __pyx_pybuffernd_position_embedding.diminfo[1].shape;
 ...
 */
  ...
  __pyx_t_20 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sequence.rcbuffer->pybuffer, (PyObject*)__pyx_t_20, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
...
static PyMethodDef __pyx_methods[] = {
  {"apply_positional_embedding", (PyCFunction)__pyx_pw_7deeprai_6engine_6cython_20positional_embedding_1apply_positional_embedding, METH_O, __pyx_doc_7deeprai_6engine_6cython_20positional_embedding_apply_positional_embedding},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpositional_embedding(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpositional_embedding(void)
#else
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_positional_embedding(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("positional_embedding", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
